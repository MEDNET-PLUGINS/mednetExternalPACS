...
@Service
public class MedSynapticsPacsReceiver extends AbstractPacsReportReceiver implements PacsReportReceiver {

    @Override
    public PACSDiagnosticsReport processRawHl7(String rawHl7, String pacsName) throws Exception {
        System.out.println("MedSynapticsPacsReceiver :: " + pacsName);
