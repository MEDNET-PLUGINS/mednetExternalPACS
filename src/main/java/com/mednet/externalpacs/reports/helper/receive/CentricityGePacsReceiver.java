...
@Service
public class CentricityGePacsReceiver extends AbstractPacsReportReceiver implements PacsReportReceiver {

    @Override
    public PACSDiagnosticsReport processRawHl7(String rawHl7, String pacsName) throws Exception {
        System.out.println("CentricityGePacsReceiver :: " + pacsName);
